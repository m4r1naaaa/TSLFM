...
## reimu: v0.4
this update includes a recycling bin in your home directory you can interact with using `mvbin`, `rmbin` and `ls bin`! also includes renaming files through rn  
